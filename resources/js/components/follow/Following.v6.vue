            ...
            <div v-for="localActor in myActors" :key="localActor.id">
                ...
                >
                    <template #actions="{ actor }">
                        <button class="btn btn-sm" @click="performAction('unfollow', actor.id, localActor.id)">Unfollow</button>
...
<script>
import FollowingTitle from './FollowingTitle.v6.vue';
import FollowingList from './FollowingList.v6.vue';
import ActorSearch from './ActorSearch.v6.vue';
