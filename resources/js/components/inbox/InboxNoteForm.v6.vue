...
export default {
    ...
    mounted() {
        console.log('ActivityPub Note Form Loaded (v6)');
    },
    methods: {
        handleInput() {
        ...
        addTag() {
            ...
            console.log('NoteForm (v6) addTag, input:', this.tagInput);
        ...
        submitForm() {
            console.log('submitForm called, pending input:', this.tagInput);
