<template>
    <div class="ap-activity-container transition-colors" :class="isMajor ? 'p-4 is-major' : 'px-4 py-2 is-minor'">
        <div class="flex gap-4 items-center" :class="{ 'items-start': isMajor }">
            ...
            <div class="flex-shrink-0">
                ...
                <div v-else class="w-8 h-8 rounded-full bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 flex items-center justify-center text-gray-500">
...
<style>
.ap-activity-container:hover {
    background-color: #f9fafb; /* gray-50 */
}

html.dark .ap-activity-container:hover,
html.is-dark .ap-activity-container:hover,
html.isdark .ap-activity-container:hover {
    background-color: rgba(38, 38, 38, 0.4); /* neutral-800/40 */
}

.ap-activity-container.is-minor {
    border-left: 4px solid #f3f4f6; /* gray-100 */
    background-color: rgba(249, 250, 251, 0.3); /* gray-50/30 */
}

html.dark .ap-activity-container.is-minor,
html.is-dark .ap-activity-container.is-minor,
html.isdark .ap-activity-container.is-minor {
    border-left-color: #262626; /* neutral-800 */
    background-color: rgba(23, 23, 23, 0.1); /* neutral-900/10 */
}
</style>
