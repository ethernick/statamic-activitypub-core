<template>
    <div class="flex rounded-lg p-1 gap-1 border ap-filter-container items-center">
        ...
        <div class="btn-group relative flex items-center ml-2" v-if="canCreateNote">
            ...
            <button type="button" @click="$emit('toggle-dropdown')" class="btn-primary !rounded-l-none px-2 border-l border-white/20 -ml-px flex items-center h-full focus:z-10">
